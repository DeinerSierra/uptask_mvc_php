...
class Email{
    ...
    public function enviarConfirmacion(){
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = '3f689702c25048';
        $mail->Password = '0ff2789c303bc7';
    ...
    public function enviarInstrucciones(){
        ...
        $contenido = '<html>';
        $contenido .="<p><strong>Hola: ". $this->nombre. "</strong> Parece que haz olvidado tu password en UpTask, cambialo en el siguiente enlace</p>";
        $contenido .= "<p>Presiona aqui: <a href='http://localhost:3000/reestablecer?token=".$this->token. "'>Reestablecer Password</a> </p>";
        $contenido .= "<p>Si no realizaste esta accion, ignora este mensaje.</p>";
        $contenido .= '</html>';
